...
import com.sina.cloudstorage.services.scs.transfer.MultipleFileDownload;
...
public class MultipleFileDownloadImpl extends MultipleFileTransfer implements MultipleFileDownload {
    ...
    @Deprecated
    public MultipleFileDownloadImpl(String description, TransferProgress transferProgress,
            com.sina.cloudstorage.services.scs.transfer.internal.ProgressListenerChain progressListenerChain, String keyPrefix, String bucketName, Collection<? extends Download> downloads) {
